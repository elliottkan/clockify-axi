export const TOP_LEVEL_HELP = `clockify-axi - Clockify's REST API for agents (AXI)
...
Notes:
  workspaceId and userId are resolved once from \`GET /user\` and cached;
  every other command uses the cache automatically. Run
